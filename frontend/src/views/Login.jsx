...
export default function Login() {
  ...
  const wrap = { display: 'flex', flexDirection: 'column', justifyContent: 'center', minHeight: '78vh', textAlign: 'center', alignItems: 'center' }

  return (
    <div className="narrow" style={wrap}>
      {head}
      <div className="muted" style={{ marginBottom: 20 }}>{t('Tus entrenamientos. Tu progreso.')}</div>
      ...
      <div className="muted small" style={{ marginBottom: 16 }}>{t('o entra con tu cuenta')}</div>

      <form style={{ width: '100%' }} onSubmit={(e) => { e.preventDefault(); signIn(); }}>
